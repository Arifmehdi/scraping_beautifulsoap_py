...
# location_url  = "lewisville-tx/acura"  ==15
...
for tr in table:
    ...
    dealer_address_info = dealer_obj[1]
    dealer_address_location = dealer_obj[2]
    ...
    item_dict = {
        ...
        "dealer_location": dealer_address_location,
...
if not cursor.fetchone():
    ...
    CREATE TABLE {table_name} (
        ...
        dealer_location VARCHAR(255) IS NULL,
        details_url TEXT,
        img_url TEXT,
        local_img_url TEXT,
        title VARCHAR(255),
...
for item_dict in result_list:
    ...
    (dealer_id, city, make, dealer_name, dealer_address,dealer_location, details_url, img_url,local_img_url, title,
    ...
    values = (
        ...
        item_dict['dealer_address'],item_dict['dealer_location'], item_dict['details_url'], item_dict['img_url'],item_dict['local_img_url'],
